package com.template.framework.aspectj;
...
import com.template.framework.web.domain.BaseEntity;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.template.framework.aspectj.lang.annotation.DataScope)")
